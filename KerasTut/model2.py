...
train_batches = ImageDataGenerator().flow_from_directory(train_path, target_size=(85, 155),
                                                         classes=[s111, s222, s211], batch_size=20,
                                                         color_mode=m_color_mode, shuffle=True
                                                         )
valid_batches = ImageDataGenerator().flow_from_directory(valid_path, target_size=(85, 155),
                                                         classes=[s111, s222, s211], batch_size=10,
                                                         color_mode=m_color_mode, shuffle=True
                                                         )
test_batches = ImageDataGenerator().flow_from_directory(test_path, target_size=(85, 155),
                                                        classes=[s111, s222, s211], batch_size=20,
...
model = Sequential([Conv2D(64, (2, 2), activation='relu', input_shape=(1,85,155)),
                    Flatten(),
